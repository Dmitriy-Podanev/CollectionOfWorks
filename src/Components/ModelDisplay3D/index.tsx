...
export const ModelDisplay3D = (data: { canvasDefaultObject: Object; three: any; style: Object; }): JSX.Element => {
    ...
    // const canvasRef2 = React.createRef<HTMLCanvasElement>()
    // let reqId = null;
    ...
    const createSceneForCanvas = (canvas, cameraOptions, geometry) => {
        ...
        // const geometry = new THREE.BoxGeometry(optionsGeometry.boxWidth, optionsGeometry.boxHeight, optionsGeometry.boxDepth);
